...
of interest(file holding the direct matlab / c++ adaptation) %
...
% Libraries enabling management of MATLAB array, vectors and matrices on % windows %
% library_files = ...
...
% clibgen generates the actual binding files,
    all the magic happens here % MATLAB nicely automates the thing,
    but getting to this point was painful % and debugging messages are very,
    very unfriendly clibgen.generateLibraryDefinition(
        hppfiles, ... % Headers "OverwriteExistingDefinitionFiles", true,
        ... % Yes I want to reload "Libraries", library_files,
        ... "IncludePath", includepath,
        ... % finds the connected header files to include on the c++ side
            "AdditionalCompilerFlags",
        ["-std=c++17"
         "-O3"],
        ... % Compiling options
        : I use standard c++ 17 constructs,
          and optimise to level 3 "PackageName", "DAGGER");
