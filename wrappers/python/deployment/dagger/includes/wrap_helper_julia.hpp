...
template<class T>
jlcxx::ArrayRef<T>
_format_output(jlcxx::ArrayRef<T>& yolo)
{
	return yolo;
}
...
template<class T>
julvec<T>
_format_input(jlcxx::ArrayRef<T>& yolo)
{
	julvec<T> gabul(yolo);
	return gabul;
}
