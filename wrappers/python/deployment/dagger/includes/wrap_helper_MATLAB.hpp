...
template<class T>
matlab::data::TypedArray<T>
_format_output(std::vector<T>& yolo)
{
	return vec2Marray<std::vector<T>, T>(yolo);
}
template<class T>
matlab::data::TypedArray<T>
_format_output(pvector<T>& yolo)
{
...
template<class T>
matlab::data::TypedArray<T>
_format_output(matlab::data::TypedArray<T>& yolo)
{
	return yolo;
}
...
template<class T>
std::vector<T>
to_vec(matlab::data::TypedArray<T>& tin)
{
...
template<class T>
matlvec<T>
_format_input(matlab::data::TypedArray<T>& yolo)
{
