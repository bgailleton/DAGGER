...
void
declare_ff(py::module& m, std::string typestr)
{
	py::class_<fastflood<double,
											 DAGGER::graph<double, CONNECTOR_T>,
											 CONNECTOR_T,
											 DAGGER::numvec<double>>>(m, typestr.c_str())
		.def(py::init<DAGGER::graph<double, CONNECTOR_T>&,
									CONNECTOR_T&,
									py::array_t<double, 1>&,
									py::array_t<double, 1>&>())
		.def("run_SFD",
		...
		.def("set_Qbase",
				 &fastflood<
					 ...
					 DAGGER::graph<double, CONNECTOR_T>,
					 CONNECTOR_T,
					 DAGGER::numvec<double>>::template set_Qbase<py::array_t<double, 1>>)
		...
		.def("get_hydraulic_slope_D8",
				 &fastflood<
					 ...
					 DAGGER::graph<double, CONNECTOR_T>,
					 CONNECTOR_T,
					 DAGGER::numvec<double>>::template get_hydraulic_slope_D8<py::array>)
		.def("spatial_dt",
				 &fastflood<
					 double,
					 DAGGER::graph<double, CONNECTOR_T>,
					 CONNECTOR_T,
					 DAGGER::numvec<double>>::template spatial_dt<py::array_t<double, 1>>)
		.def("set_dt",
				 &fastflood<double,
										DAGGER::graph<double, CONNECTOR_T>,
										CONNECTOR_T,
										DAGGER::numvec<double>>::set_dt)
		.def("enable_Afdt",
				 &fastflood<double,
										DAGGER::graph<double, CONNECTOR_T>,
										CONNECTOR_T,
