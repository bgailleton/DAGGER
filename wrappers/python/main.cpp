...
void declare_graph(py::module &m, std::string typestr)
{
	...
	py::class_<graph<double, CONNECTOR_T > >(m, typestr.c_str())
		...
		.def("get_SFD_receivers_at_node", &graph<double, CONNECTOR_T >:: get_SFD_receivers_at_node)
		.def("get_SFD_dx_at_node", &graph<double, CONNECTOR_T >:: get_SFD_dx_at_node)
		.def("get_SFD_ndonors_at_node", &graph<double, CONNECTOR_T >:: get_SFD_ndonors_at_node)
