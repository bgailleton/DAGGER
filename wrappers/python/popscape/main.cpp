...
void declare_popscape(py::module &m, std::string typestr) {
  py::class_<popscape<double, DAGGER::graph<double, CONNECTOR_T>, CONNECTOR_T>>(
      ...
      .def("get_topo", &popscape<double, DAGGER::graph<double, CONNECTOR_T>,
                                 CONNECTOR_T>::template get_topo<py::array>)
      .def("get_QA", &popscape<double, DAGGER::graph<double, CONNECTOR_T>,
      ...
      .def("apply_uplift", &popscape<double, DAGGER::graph<double, CONNECTOR_T>,
                                     CONNECTOR_T>::apply_uplift)
      .def("apply_variable_uplift",
           &popscape<double, DAGGER::graph<double, CONNECTOR_T>, CONNECTOR_T>::
      ...
      .def("run_SFD_exp_latmag",
           &popscape<double, DAGGER::graph<double, CONNECTOR_T>,
                     CONNECTOR_T>::run_SFD_exp_latmag)
...
void declare_trackscape(py::module &m, std::string typestr) {
  py::class_<
      ...
      .def("hillslopes_on",
           &trackscape<double, DAGGER::graph<double, CONNECTOR_T>,
                       CONNECTOR_T>::hillslopes_on)
      .def("hillslopes_off",
           &trackscape<double, DAGGER::graph<double, CONNECTOR_T>,
                       CONNECTOR_T>::hillslopes_off)
      .def("fluvial_on", &trackscape<double, DAGGER::graph<double, CONNECTOR_T>,
                                     CONNECTOR_T>::fluvial_on)
      .def("fluvial_off",
           &trackscape<double, DAGGER::graph<double, CONNECTOR_T>,
                       CONNECTOR_T>::fluvial_off)
